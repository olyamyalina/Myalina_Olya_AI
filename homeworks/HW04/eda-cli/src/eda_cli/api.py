...
# ---------- HW04: собственный эндпоинт на базе HW03 ----------


@app.post(
    "/quality-flags-from-csv",
    tags=["quality"],
    summary="Булевы флаги качества датасета из EDA-ядра (HW03)",
)
async def quality_flags_from_csv(file: UploadFile = File(...)) -> dict:
    """
    Принимает CSV-файл и возвращает полный набор булевых флагов качества,
    рассчитанных в HW03 (compute_quality_flags).
    """
